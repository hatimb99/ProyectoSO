...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void listaconectados_Click(object sender, EventArgs e)
        {
            ...
            //private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e, string textoP)
            //{
            //    List<string> list = textoP.Split(new[] {"\n"}, StringSplitOptions.RemoveEmptyEntries).ToList();
            //    matriz.ColumnCount = 1;
            //    matriz.RowCount = list.GetLenght();

            //    int i = 0;
            //    while (i < list.GetLenght())
            //    {
            //        matriz[0, i + 1].Value = list.textoP(i);
            //        i=i+1;
            //    }
        }
